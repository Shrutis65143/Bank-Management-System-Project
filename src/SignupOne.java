...
public class SignupOne extends JFrame implements ActionListener{
    ...
    SignupOne(){
        ...
        datechos =new JDateChooser();
        datechos.setBounds(300,240,400,30);
        datechos.setForeground(new Color(105,105,105));
        add(datechos);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        String dob = ((JTextField) datechos.getDateEditor().getUiComponent()).getText();
        String gender  = null;
        if(male.isSelected()){
            gender = "Male";
        ...
        try {
            if(name.equals("")){
                ...
                Conn c = new Conn();
                String query = "insert into signup values('"+formno+"','"+name+"','"+fathername+"','"+dob+"','"+gender+"','"+email+"','"+maritial+"','"+address+"','"+city+"','"+pincode+"','"+state+"')";
