...
public class SignupTwo extends JFrame implements ActionListener{
    ...
    SignupTwo(String formno){
        ...
        String valcategory[] = {"General","OBC","SEC","SC","Other"};
        ...
        String valincome[] = {"Null","< 1,50,000","< 3,00,000","< 5,00,000","Up to 10 lakh"};
        ...
        String educationvalue[] = {"Non garduation","Graduate","Post graduation","Doctorate","Others"};
        ...
        String valoccupation[] = {"Salaried","Non salaried","Business","Student","Other"};
